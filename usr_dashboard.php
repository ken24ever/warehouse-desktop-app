...
.block{margin:35px auto; width:260px; height:122px; border:1px blue solid; border:6px #666666 outset;  background-image:url(images/slate_bg.jpg); color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:18px; border-radius:25px; box-shadow:#737373 1px 14px 14px 0px; cursor:pointer;}
.btn{ font-size:18px; font-weight:bold;}
.bor_line{ border-radius:22px;}
.text-center{ padding:40px 50px; font-family:Tahoma; font-size:30px; font-weight:800;}
.text-center1{ padding:40px 30px; font-family:Tahoma; font-size:30px; font-weight:800;}
...
<span class="icon-bar"></span>
 ...
 <a class="logo navbar-brand" href="#"><strong class="logo"><img src="images/logo_2.png" width="500" height="50"></strong></a>
</div>
<div class="collapse navbar-collapse" id="example-navbar-collapse">
<ul class="li nav navbar-nav  navbar-right">
<li class="active"><a href="admin.php"><span class="glyphicon glyphicon-user"></span> Dashboard</a></li>
<li class="" ><a href="usr_dashboard.php"><span class=" glyphicon glyphicon-refresh"></span>&nbsp;Refresh</a></li>
...
<div class="container">
    <div class="row">
      ...
      <div class="title page-header">
          ...
          <h2 style=" font-family:Tahoma;  font-weight:bold"> <span class="glyphicon glyphicon-user"> User Dashboard</span></h2>
