...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <h2 style="color:#000000; font-family:Tahoma;  font-weight:bold">Inventory</h2>
          
        </div>
      
      
      <form role="form"  method="post" action="inventory.php" class="form" onSubmit="">
          ...
          <div class="form-group col-md-8">
              ...
              <input type="text" id="manufacturingdate" name="manufacturingdate" placeholder="Enter Manufacturing Date" class="form-control" >
            
          </div>
          <div class="form-group col-md-8">
              <label class="label" for="expirydate">Expiry Date</label>
              <input type="text" id="expirydate" name="expirydate" placeholder="Enter Expiry Date" class="form-control" >
            
          </div>
          <div class="form-group col-md-8">
               <br/>
               <input  type="submit" id="addproduct" name="addproduct" class="btn btn-success" value="Add New Product"  class="form-control" >
                                
          </div>
           <div class="form-group col-md-8">
              <label class="label" for="notificationprompt">Notification Prompt</label>
              <input type="text" id="notificationprompt" name="notificationprompt" class="form-control" >
