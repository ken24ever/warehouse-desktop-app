...
.text-center1{padding:70px 20px;}
 ...
 /* sales modal layout */
 .main{ border:5px grey groove; border-radius:22px; height:545px;  overflow:hidden;}
 .inner{ height:auto;  border-right:5px grey groove; }
 .credit_repay_form{height:1000;  }
.inner_2nd_main{height:530px; border-top:5px grey groove; }
...
// by default input fields and add item button are disabled
 $(document).ready(function (){
 ...
 $("#add_sales").attr('disabled','disabled');
  $("#tot_amt").attr('disabled','disabled');
   $("#amt_due").attr('disabled','disabled');
 })
...
// $("#psprice").removeAttr('disabled');
 ...
 $('.gen').attr('disabled','disabled').css({"background":"red"});
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h1>SALES</h1>
      <input  type="button" id="gen_id" name="gen_id" class="gen btn btn-success" value="Generate Sales"   class="form-control" >
    <!--  <input  type="button" id="view_All" name="view_All" class="view_All btn btn-success" value="Items to Confirm"   class="form-control" >-->
    <input  type="button" id="getAmtDue" name="getAmtDue" class="getAmtDue btn btn-success" value="Get Total Amount"   class="form-control" >   <!-- <input  type="button" id="viewSales" name="viewSales" class="viewSales btn btn-success" value="view Sales Items"   class="form-control" >-->
    </div>
    ...
    <div class="container-fluid">
      ...
      <div class="form-group col-md-6">
        <label class="label1" for="productcode">Product Code</label>
             <input type="text" id="pscode"  name="pscode" placeholder="Enter Product Code"  class="pscode form-control" >
         </div> 
         <div class="form-group col-md-6">              
              <label class="label1" for="productname">Product Name</label>
              <select id="psname" name="psname" class="form-control">
           ...
           <div class="form-group col-md-6">
              <label class="label1" for="quantity">Quantity</label>&nbsp;&nbsp;<span class="output_stream"></span>
        ...
        <label class="label1" for="productcode">Total Amount</label>
         ...
         <div class="form-group col-md-6">              
            ...
            <div class="form-group col-md-12">              
              <label class="label1" for="productname" >Color</label>
              <input type="text" id="color" name="color" placeholder="Enter Color" class="sales_form form-control" >
           </div>
...
<div id="myModal2" class="modal2">
  ...
  <div class="modal-content2">
    ...
    <h1>CUSTOMER NAME
     <span class="close2"><button class="btn btn-danger">X</button></span></h1>
    </div>
    <div class="modal-body2">
     
  <div class="page-header"></div>
   <form  method="post"  action="<?php echo $_SERVER['PHP_SELF']; ?>" onSubmit="return false" class="form">
         
       
              <label class="label1" for="custName">ENTER CUSTOMER NAME</label>
              <input type="text" name="cus_name" id="cus_name" placeholder="Enter Customer Name" class="sales_form form-control" >
         <br/>
                              ...
                              <div class="row">
                                 <div class="col-md-12" style="overflow:hidden">
                                    ...
                                    <table border="2" style="margin:4px;vertical-align:inherit" border="1"   >
                                           ...
                                           <thead>
                                            <th style='width:20%; padding:14px; font-size:11px'>PRODUCT CODE</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>PRODUCT NAME</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>QUANTITY SOLD</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>UNIT PRICE</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>DISCOUNT</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>MODE OF PAYMENT</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>TOTAL AMOUNT</th>
                                           <th style='width:20%;padding:14px;font-size:11px'>AMOUNT DUE</th>
                                    ...
                                    <div id="live_add_sales" ></div>
                                     <div id="live_delete" ></div>
                                     <span id="tot_amt_due"> </span>
                                     </table>
...
<div id="myModal4" class="modal4">
  ...
  <div class="modal-content4">
    ...
    <div class="modal-body4">
      <div id="modal_alert"> Empty fields, Fill All! </div>
    </div>
