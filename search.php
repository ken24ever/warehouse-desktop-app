...
$search = $_POST["searchMe"];
 ...
 class MyDB extends SQLite3
        ...
        $sql = "SELECT * FROM users WHERE user_name = '$search' "; // query the person
		    $ret = $db->query($sql);
  ...
  <td align="center" class="user_name" data-id2="'.$row["user_id"].'" contenteditable title="edit me"><font size="-1">'.$row["user_name"].'</font></td>
 ...
 <td align="center"  class="last_login_date" data-id5="'.$row["user_id"].'" ><font size="-1"><button type="button" value="'.$row["user_id"].'"  id="edit" class="btn btn-success">Change</button></font></td>
